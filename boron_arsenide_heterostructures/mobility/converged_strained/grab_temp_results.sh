...
echo $t $emx $emy $emz $ema $hmx $hmy $hmz $hma $emf $hmf $esprd $hsprd >> temp_72_data_strain.dat
echo $t,$emx,$emy,$emz,$ema,$hmx,$hmy,$hmz,$hma,$emf,$hmf,$esprd,$hsprd >> temp_72_data_strain.csv
